...
public class Volume {
    ...
    /* A voxel, given the coordinates. As it is a linear array, do the math... */
    ...
    /**
     * Minimum and maximum just iterate over the whole array finding the value...
     */
